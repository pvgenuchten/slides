...
## pycsw in [Soilwise](https://www.soilwise.eu)
...
## Metadata harvesting and alignment

- Harvests from various Geo and Academia repositories
- Aligns metadata between communities
- A SOLR backend to improve findability
- Focus on datamodel metadata
