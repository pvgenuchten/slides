...
subtitle: an initiative to increase awareness on metadata
...
- Alongside a data file/table (sidecar)
- During registration in a repository
- In a catalogue
...
- Systems enrich metadata with performance indicators
...
## How become Cordis and EUSO aware of metadata?
...
- Many repositories (including Zenodo) have an option to provide `subjects`, which is a combination of thesaurus + keyword.
- EUSO endorses to select 1 or multiple keywords from 10-ish thesauri.

## What is the benefit of adopting the profile?

- Your metadata will be harvested and your project output being found
- Your project output will be included in aggregated statistics
