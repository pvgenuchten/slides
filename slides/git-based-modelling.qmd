...
- Audience: Cropping experts comfortable in configuring a local SWAT model  
...
- https://github.com/watdev-eu/watdev-model-template
...
- Assess the results (in output branch)
...
- Link a Github repository to Zenodo
- 
